...
.then( function ( smk ) {
	...
	// Load resources for this demo
    window.include.tag( "leaflet2",
        { loader: "sequence", tags: [
            // add Leaflet VectorGrid
            { loader: "script", url: "https://unpkg.com/leaflet.vectorgrid@1.2.0" },

            // include EU countries definition used in Sliced GeoJSON demo
            { loader: "script", url: "https://leaflet.github.io/Leaflet.VectorGrid/eu-countries.js" }
        ] }
    );
