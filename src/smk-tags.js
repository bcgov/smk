...
t.script( 'turf', 'lib/turf-6.5.0.min.js' )
...
t.sequence( 'leaflet' )
    .script( 'lib/leaflet/leaflet-1.9.2.js' )
    .style( 'lib/leaflet/leaflet-1.9.2.css', { inline: false } )
    .script( 'lib/leaflet/leaflet-geoman-2.13.0.min.js' )
    .style( 'lib/leaflet/leaflet-geoman-2.13.0.css', { inline: false } )
    .script( 'lib/leaflet/esri-leaflet-3.0.8.js' )
    .script( 'lib/leaflet/esri-leaflet-renderers-3.0.0.js' )
    .script( 'lib/leaflet/esri-leaflet-legend-compat-src-2.0.1.js')
    .script( 'lib/leaflet/esri-leaflet-vector-4.0.0.js' )
