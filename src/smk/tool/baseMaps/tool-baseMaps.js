    ...
    return SMK.TYPE.Tool.define( 'BaseMapsTool',
        ...
        function ( smk ) {
            ...
            this.basemaps = Object.keys( smk.$viewer.basemap )
                ...
                .map( function ( bm ) {
                    ...
                    bm.create = function ( el ) {
                        ...
                        var bmLayers = smk.$viewer.createBasemapLayer( smk.viewer.esriApiKey, bm.id )
            ...
            function setBasemap( basemap ) {
                smk.$viewer.setBasemap( smk.viewer.esriApiKey, basemap.id )
            }
            ...
            smk.$viewer.setBasemap( smk.viewer.esriApiKey, smk.viewer.baseMap )
        }
    )
} )
